...
- No toolchain: the repo is CloudFormation JSON, one resource per file; the applier is CloudFormation; lint and proofs are Access Analyzer (decision 31). The agent app is [the AWS desk](../../docs/aws-desk.md). chant and Terraform live in the back office only.
